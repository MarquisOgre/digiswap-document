...
{% hint style="warning" %}
Digiswap is based on Uniswap v2. Read the [Uniswap v2 documentation](https://uniswap.org/docs/v2/).  
...
**Contract name:** DigiswapFactory  
**Contract address:** 0x98813bD470A3BA8Da3D16488c58374e8dBc2FF22

View the [Digiswap: Factory v2 contract on BscScan](https://bscscan.com/address/0x98813bD470A3BA8Da3D16488c58374e8dBc2FF22).
