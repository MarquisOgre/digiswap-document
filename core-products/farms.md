...
**Initial Liquidity Pools \(LPs\) for farming DIGIS tokens:**
...
**\*\*\[**Get your FLIP tokens \(Digiswap Liquidity Provider Tokens\) HERE**\]\(**[https://exchange.dex.digiswap.finance/\#/swap](https://exchange.dex.digiswap.finance/#/swap)**\)**.\*\*
