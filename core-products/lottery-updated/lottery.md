...
* Lottery Ticket Fee for 1 ticket: 1 DIGIS 
* Single User Lottery Entry Limit: No limit
* Paying for one ticket \(1 DIGIS\) will give users a random 4 digit combination with each digit being between 1-10, for e.g. “1-9-3-2”
* In the UI, users can choose to enter a multiple of 10 DIGIS, which will buy them multiple tickets. 
...
* Users will receive a ticket \(comprised of 4 digits\) for each 1 DIGIS paid.
