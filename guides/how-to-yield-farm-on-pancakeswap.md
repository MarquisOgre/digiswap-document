...
**3. Pick which farm you want to use. For this example, we will pick the DGP-BNB farm.**
...
**5. Select the tokens to add, in this case BNB and DGP. You need to provide them in a 50/50 ratio vs USD value.**

**For example, you would need to add $10 of BNB and $10 of DGP. Once you are done, click “Supply”.**
...
**11. Done! Now you are farming DGP tokens!**
