...
Buy new tokens using DIGIS.&#x20;

The project gets the DIGIS, Digiswap burns the participation fees DIGIS. **You get the tokens.**

1. **You will need DIGIS** to participate.
...
2. Done! In the case of an [overflow](https://app.gitbook.com/@digiswap-1/s/pancakeswap/\~/drafts/-MMK-KmBq5\_Mfs94Ul6x/core-products/ifo-initial-farm-offering#overflow) you can reclaim your remaining DIGIS tokens.
...
{% hint style="warning" %}
It's possible to receive no tokens at all: If you commit a very small amount of DIGIS compared to the total amount committed by others, your contribution may be such a small part of the total that you may not qualify for even a small portion of the tokens sold.\
In such a case, you will still be able to reclaim all the DIGIS tokens you committed.
{% endhint %}
