...
Why? Because when you stake your LP tokens in a farm to earn DGP, you're still providing liquidity to the liquidity pool, so you earn LP rewards as well!
...
The **Farm Base APR** is calculated according to the farm multiplier and the total amount of liquidity in the farm -- this is the amount of DGP distributed to the farm.
