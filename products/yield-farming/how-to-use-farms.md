...
Yield Farming in Farms is a great way to earn DGP rewards on Digiswap.

Unlike Syrup Pools, Farms require you to stake **two tokens** to get LP Tokens, which you then stake in the Farm to earn rewards. This lets you earn DGP while still keeping a position in your other tokens!
...
You’re going to need some "LP Tokens" to enter into a Farm with. Farms can only accept their own exact LP Token; for example, the DGP-BNB Farm will only accept DGP-BNB LP Tokens.

To get the exact LP Token, you'll need to provide liquidity for that trading pair. So to get DGP-BNB LP Tokens, you'll first have to provide liquidity for the DGP-BNB pair.
...
DGP-BNB and BUSD-BNB are pinned to the top of the list with the default **Hot** sorting. After the pinned Farms, Hot will show other Farms in order of how new they are.

You can choose another sorting option if you like, such as by **APR** for the Farms with the highest reward rate currently.

When you find a Farm that you'd like to use, note down the trading pair, e.g. BNB-DGP in case you need it later.
...
Farming will bring you DGP rewards over time. You can collect these rewards and use them to get more LP Tokens, stake them in Syrup Pools, use them to play Lottery, or anything else you’d like.
...
To collect your rewards, you’ll need to visit your chosen Farm and collect the DGP waiting for you.
...
1. Click the **Harvest** button and confirm the action in your wallet. After a short wait, the DGP will be claimed to your wallet for you to use as you like.
